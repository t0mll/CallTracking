...
namespace CallTraking.NEventSocket.Common.FreeSWITCH.Applications.Originate
{
    /// <summary>
    ...
    public class OriginateOptions : ISerializable
    {
        ...
        public bool ReturnRingReady
        {
            get
            {
                return bool.TryParse(parameters.GetValueOrDefault("return_ring_ready"), out bool returnRingReady) && returnRingReady;
            }
